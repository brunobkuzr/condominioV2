    ...
    public void atualizar(Esgoto esg) {
        if (esg != null) {
            ...
            try {
                ...
                pstm.setFloat(1, esg.getLei01());
                pstm.setFloat(2, esg.getLei02());
                pstm.setFloat(3, esg.getLei03());
                pstm.setFloat(4, esg.getLei04());
                pstm.setFloat(5, esg.getLei05());
                pstm.setFloat(6, esg.getLei06());
                pstm.setFloat(7, esg.getLei07());
                pstm.setFloat(8, esg.getLei08());
                pstm.setFloat(9, esg.getLei09());
                pstm.setFloat(10, esg.getLei10());
                pstm.setFloat(11, esg.getLei11());
                pstm.setFloat(12, esg.getLei12());
                pstm.setDate(13, esg.getData01());
                pstm.setDate(14, esg.getData02());
                pstm.setDate(15, esg.getData03());
                pstm.setDate(16, esg.getData04());
                pstm.setDate(17, esg.getData05());
                pstm.setDate(18, esg.getData06());
                pstm.setDate(19, esg.getData07());
                pstm.setDate(20, esg.getData08());
                pstm.setDate(21, esg.getData09());
                pstm.setDate(22, esg.getData10());
                pstm.setDate(23, esg.getData11());
                pstm.setDate(24, esg.getData12());
                pstm.setInt(25, esg.getIdCond());
                pstm.setInt(26, esg.getIdBloco());
                pstm.setInt(27, esg.getIdApart());
                pstm.setInt(28, esg.getAno());
                pstm.execute();
