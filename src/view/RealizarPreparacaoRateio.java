 ...
 * @author lucasreinert
 */
public class RealizarPreparacaoRateio extends javax.swing.JDialog {

    /**
     * Creates new form RealizarPreparacaoRateio
     */
    public RealizarPreparacaoRateio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RealizarPreparacaoRateio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RealizarPreparacaoRateio dialog = new RealizarPreparacaoRateio(new javax.swing.JFrame(), true);
