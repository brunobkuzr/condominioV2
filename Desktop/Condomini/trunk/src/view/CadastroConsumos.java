...
public class CadastroConsumos extends javax.swing.JDialog {
   ...
   SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
        ...
        if (cbTipoConsumo.getSelectedItem() == "Gas"){
        Gas gas = new Gas();
        ...
        if(edCon01.getText() != ""){
            ...
            if(edDat01.getText() != ""){
                try {
                    gas.setData01((Date) formato.parse(edDat01.getText()));
        ...
        if(edCon02.getText() != ""){
            ...
            if(edDat02.getText() != ""){
                try {
                    gas.setData02((Date) formato.parse(edDat02.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if(edCon04.getText() != ""){
            ...
            if(edDat04.getText() != ""){
                try {
                    gas.setData04((Date) formato.parse(edDat04.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if(edCon05.getText() != ""){
            ...
            if(edDat05.getText() != ""){
                try {
                    gas.setData05((Date) formato.parse(edDat05.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if(edCon06.getText() != ""){
            ...
            if(edDat06.getText() != ""){
                try {
                    gas.setData06((Date) formato.parse(edDat06.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if(edCon07.getText() != ""){
            ...
            if(edDat07.getText() != ""){
                try {
                    gas.setData07((Date) formato.parse(edDat07.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if(edCon08.getText() != ""){
            ...
            if(edDat08.getText() != ""){
                try {
                    gas.setData08((Date) formato.parse(edDat08.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if(edCon09.getText() != ""){
            ...
            if(edDat09.getText() != ""){
                try {
                    gas.setData09((Date) formato.parse(edDat09.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if(edCon10.getText() != ""){
            ...
            if(edDat10.getText() != ""){
                try {
                    gas.setData10((Date) formato.parse(edDat10.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if(edCon11.getText() != ""){
            ...
            if(edDat11.getText() != ""){
                try {
                    gas.setData11((Date) formato.parse(edDat11.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if(edCon12.getText() != ""){
            ...
            if(edDat12.getText() != ""){
                try {
                    gas.setData12((Date) formato.parse(edDat12.getText()));
                } catch (ParseException ex) {
                    Logger.getLogger(CadastroConsumos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
